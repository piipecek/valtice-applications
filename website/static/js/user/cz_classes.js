...
for (let trida of data) {
    ...
    option.textContent = trida.full_name_cz
...
function handle_trida_display() {
    ...
    class_name.textContent = trida.full_name_cz
    ...
    last_main_li.textContent = trida.main_participants_anonymous_cz
    ...
    last_secondary_li.textContent = trida.secondary_participants_anonymous_cz
