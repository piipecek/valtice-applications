...
with app.app_context():
    ...
    Valtice_trida(short_name="Jürgen Banholzer | Ansámbly", full_name="Jürgen Banholzer – Vokální ansámbly").update()
    Valtice_trida(short_name="Barbora Kabátková", full_name="Barbora Kabátková – Gregoriánský chorál").update()
    Valtice_trida(short_name="Robert Hugo", full_name="Robert Hugo – Sbor").update()
    ...
    Valtice_trida(short_name="Peter Holtslag | Komorní hudba", full_name="Peter Holtslag – Komorní hudba").update()
    ...
    Valtice_trida(short_name="Corina Marti | Ansámbly", full_name="Corina Marti – Středověké ansámbly").update()
    ...
    Valtice_trida(short_name="Marek Štryncl", full_name="Marek Štryncl – Barokní orchestr").update()
    ...
    Valtice_trida(short_name="Ondřej Šmíd", full_name="Ondřej Šmíd – Zpěv při bohoslužbě").update()
    print("done")